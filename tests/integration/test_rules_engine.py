...
from services.rules_engine.repository import (
    InMemoryFindingRepository,
    InMemoryRuleRegistryRepository,
)
...
condition: kwh > 100
    ...
    service = DomainRuleEngineService(
        rule_registry=registry, finding_repository=finding_repo, root_cause_handoff=handoff
    )
    ...
    findings = service.process_readings(
        tenant_id, building_id, building_context, readings, circuit_types
    )
