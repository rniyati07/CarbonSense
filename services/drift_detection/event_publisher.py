...
class KafkaDriftEventPublisher:
    ...
    def publish_drift_detected(self, payload: DriftEventPayload) -> None:
        ...
        try:
            ...
            self._logger.info("Published drift detected event", building_id=str(payload.building_id))
        except KafkaException as e:
            self._logger.error("Failed to publish drift detected event", error=str(e), building_id=str(payload.building_id))
    ...
    def publish_customer_notification(self, tenant_id: str, building_id: str) -> None:
        ...
        topic = "customer.notification.created"
        message = {
            "tenant_id": tenant_id,
        ...
        try:
            ...
            self._logger.error("Failed to publish customer notification", error=str(e), building_id=building_id)
            raise
